...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./Style/contactupdate.css">
        <link rel="stylesheet"
    ...
    <body>
        ...
        <form action="updateContactus" method="post">
            <section>
                <div>
                    <h1>
                        Contact Us
                ...
                <div>
                    <div>
                     <input type="hidden" name="Contactid" value="<%= id%>">
                        <p> Name </p>
                        <input type="text" name="name"  value = "<%= name%>" size="30px" maxlength="20"
                            autocomplete="off" required>
                    </div>
                    <div>
                        <p> Email </p>
                        <input type="email" name="email" size="30px"  value = "<%= Email%>"
                            maxlength="50" autocomplete="off" required>
                    </div>
                    <div>
                        <p> Message </p>
                         <textarea id="review" name="Msg" 
